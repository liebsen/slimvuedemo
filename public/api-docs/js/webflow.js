...
Webflow.require('ix').init([
  {"slug":"scroll-ut","name":"scroll-ut","value":{"style":{},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"transition":"opacity 200 ease 0"}],"stepsB":[{"opacity":0,"transition":"opacity 200 ease 0"}]}]}}
]);
